...
module.exports = function(t, definition, version, adjustResourceQuantity) {
  ...
  const relationships = buildResponseRelationships(t, definition, version, adjustResourceQuantity);
